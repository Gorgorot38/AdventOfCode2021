export class Day14 {
  ...
  public part1(): string {
    ...
    return (Math.max(...mapStr.values()) - Math.min(...mapStr.values())).toString();
  }
  ...
  public part2(): string {
    ...
    return (Math.max(...letterMap.values()) - Math.min(...letterMap.values())).toString();
  }
